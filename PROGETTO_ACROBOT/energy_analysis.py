...
# #########################   DYNAMICS PARAMETERS and MATRICES   #########################
    ...
    # @@@@@@@@@@   PAPERS DYNAMICS   @@@@@@@@@@
    Ma = np.array([[alpha1+alpha2+2*alpha3*np.cos(q[1]), alpha2+alpha3*np.cos(q[1])],
...
# #########################   COMPUTES ENERGIES (already done Desired_Energy)   #########################
    ...
    return acrobot_energy, desired_energy, Ma, Co, Gr, M_det, gains