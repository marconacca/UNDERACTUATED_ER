...
from plot_function import plotting_conf, plotting_vel, plotting_singleval
...
def simulate():
    ...
    simTime = 30 # total simulation time in seconds (was 25)
    ...
    plotting_vel(seconds, torques_history, 'timestep', 'Torque [N*m]', ['Tau1', 'Tau2'], 'Torques Tau wrt time')
